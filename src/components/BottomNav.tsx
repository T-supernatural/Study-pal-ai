...
export const BottomNav: React.FC = () => {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 z-50 px-4 pb-6 pt-2 pointer-events-none">
      <div className="max-w-md mx-auto liquid-glass rounded-full px-6 py-3 shadow-xl flex items-center justify-between pointer-events-auto border border-white/50 relative">
        {navItems.map((item) => {
          ...
          if (item.isFab) {
            return (
              ...
              >
                ...
                {isActive && (
                  <span className="absolute -bottom-1.5 w-1.5 h-1.5 rounded-full bg-royal animate-ping" />
                )}
              </button>
            );
          }
          ...
          return (
            <button
              ...
              className="flex flex-col items-center justify-center p-2 relative text-powder hover:text-royal transition-all duration-300"
            >
              <IconComponent
              ...
              {isActive && (
                <span className="absolute -bottom-1 w-1 h-1 rounded-full bg-royal" />
              )}
            </button>
          );
        })}
